package yalc_java.sec07.chap03.ex01;

import yalc_java.sec05.chap08.ex01.YalcoChicken;
...
public class Main {
    public static void main(String[] args) {
        ...
        //  원시값 배열(double[])을 쓰면 오류 - [배열로는 오토박싱]이 안 되므로
    ...
    public static <T> T pickRandom (T a, T b) { // 반환값이 : T라는 입력 자료형
