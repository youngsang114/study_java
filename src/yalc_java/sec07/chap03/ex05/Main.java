package yalc_java.sec07.chap03.ex05;
...
//        grandeur.setRider(new Knight()); // ⚠️ 불가
        ...
        // Horse 즉 말들은 상속 관계가 있는게 아님 -> 말에 타는 unit,knight,magic knight이 상속관계가 있는 것 -> 다형성 적용 X
...
//        HorseShop.intoEntryLevels(grandeur); // ⚠️ 불가
        ...
        } // ⁉️ 에러 발생하지 않음 ->for문에서 avante,sonata,grandeur가 아닌 Horse자료형인 horse 변수로 인식되서 extends Unit이면 다 가능하다
